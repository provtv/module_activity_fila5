...
| `getInfolistSchema` | 3 | candidato a trait/helper |
...
| `boot` | 2 | possibile duplicazione |
| `getPages` | 2 | possibile duplicazione |
| `getRelations` | 2 | possibile duplicazione |
| `getTableActions` | 2 | possibile duplicazione |

... altri 4 metodi duplicati non elencati per sintesi.
